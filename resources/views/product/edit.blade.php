...
@section('content')
    <section class="py-4">
        ...
        <div class="container px-4 px-lg-5 mt-4">
            <form class="needs-validation" novalidate="" action="{{ url('products/' . $product->id) }}" method="post">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="date" name="date_fabrication" class="form-control"
                            value="{{ explode(' ', $product->date_fabrication)[0] }}">
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" name="is_active" type="checkbox" role="switch"
                                {{ $product->is_active ? 'checked' : '' }} id="flexSwitchCheckDisabled">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row">
                            <div class="col-6">
                                <button class="w-100 btn btn-primary" type="submit">Salvar produto</button>
                            </div>
                            <div class="col-6">
